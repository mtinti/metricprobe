...
.venv/bin/python -m pip install "metricprobe[export] @ git+https://github.com/OWNER/metricprobe@v0.1.1"
...
```
pip install "metricprobe[export] @ git+https://github.com/OWNER/metricprobe@v0.1.1"
```

...
.venv/bin/python -m pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.1.5"
...
```
pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.1.5"
```

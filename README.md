...
.venv/bin/python -m pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.2.1"
...
```
pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.2.1"
```

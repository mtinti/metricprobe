...
.venv/bin/python -m pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.1.6"
...
```
pip install "metricprobe[export] @ git+https://github.com/mtinti/metricprobe@v0.1.6"
```

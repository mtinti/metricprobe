...
.venv/bin/python -m pip install "metricprobe[export] @ git+https://github.com/OWNER/metricprobe@v0.1.3"
...
```
pip install "metricprobe[export] @ git+https://github.com/OWNER/metricprobe@v0.1.3"
```
